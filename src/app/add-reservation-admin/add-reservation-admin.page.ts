...
@Component({
  ...
  templateUrl: './add-reservation-admin.page.html',
  styleUrls: ['./add-reservation-admin.page.scss'],
})
export class AddReservationAdminPage implements OnInit {
  ...
  habitacionesDisp(){
    this.router.navigate(['hab-dis-admin/'+this.activateRoute.snapshot.paramMap.get('fechaInicio')+'/'+this.activateRoute.snapshot.paramMap.get('fechaFin')])
  }
}