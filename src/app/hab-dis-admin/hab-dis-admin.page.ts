...
import { Habitacion, Precio, Reserva } from '../shared/userinterface';

@Component({
  selector: 'app-hab-dis-admin',
  templateUrl: './hab-dis-admin.page.html',
  styleUrls: ['./hab-dis-admin.page.scss'],
})
export class HabDisAdminPage implements OnInit {
  ...
  reservar(habitacion, monto){
    ...
    this.router.navigate(['add-reservation-admin/'+this.activateRoute.snapshot.paramMap.get('fechaInicio')+'/'+this.activateRoute.snapshot.paramMap.get('fechaFin')+'/'+habitacion+'/'+monto])
  }
}
