...
@Component({
  ...
  templateUrl: './busqueda-admin.page.html',
  styleUrls: ['./busqueda-admin.page.scss'],
})
export class BusquedaAdminPage implements OnInit {
  ...
  parametros(fechaInicio, fechaFin){
    ...
    this.router.navigate(['hab-dis-admin/'+fecha1+'/'+fecha2])
  }
